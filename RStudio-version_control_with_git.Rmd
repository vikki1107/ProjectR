...
$~$  
![](/media/vikki/Flex/ProjectR/image/Selection_003.png)  
$~$  
...
![](/media/vikki/Flex/ProjectR/image/Selection_004.png)
...
![](/media/vikki/Flex/ProjectR/image/Selection_005.png)  
$~$  
...
$~$  
![](/media/vikki/Flex/ProjectR/image/Selection_006.png)  
$~$  
...
$~$  
![](/media/vikki/Flex/ProjectR/image/Selection_007.png)
$~$  

4. Click on **Commit** from the git window 
![](/media/vikki/Flex/ProjectR/image/Selection_008.png)
$~$
...
![](/media/vikki/Flex/ProjectR/image/Selection_009.png)
$~$
...
If you don't see Git tab under Environment, History Pane then 
    ...
    ![](/media/vikki/Flex/ProjectR/image/Selection_010.png)
$~$  
$~$  
